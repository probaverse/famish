...
For a complete walkthrough, including comparisons between multiple fitted families and tail-focused diagnostics, see the [fitting vignette](articles/fitting.html). The snippet below shows the minimal workflow.
