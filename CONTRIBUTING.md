# Contributing to famish

Thank you for considering contributing to `famish`! This package and the
probaverse more generally have ambitious goals, so your help is needed.
...
Conduct](https://famish.netlify.app/CODE_OF_CONDUCT.md). By
...
[GitHub](https://github.com/probaverse/famish/issues) with:
...
`famish` follows the [tidyverse style
