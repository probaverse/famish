...
#' @export
fit_dst_beta <- function(x,
                         method = c("mle", "mge", "mme"),
                         ...) {
  method <- rlang::arg_match(method)
...
#' @rdname fit_dst_family_wrappers
#' @export
fit_dst_chisq <- function(x,
                          method = c("mle", "mge", "lmom"),
                          ...) {
  method <- rlang::arg_match(method)
...
#' @rdname fit_dst_family_wrappers
#' @export
fit_dst_exp <- function(x,
                        method = c("mle", "mge", "mme", "lmom"),
                        ...) {
  method <- rlang::arg_match(method)
...
#' @rdname fit_dst_family_wrappers
#' @export
fit_dst_geom <- function(x,
                         method = c("mle", "mme", "lmom"),
                         ...) {
  method <- rlang::arg_match(method)
...
#' @rdname fit_dst_family_wrappers
#' @export
fit_dst_lp3 <- function(x,
                        method = c("mle", "mge", "lmom-log"),
                        ...) {
  method <- rlang::arg_match(method)
